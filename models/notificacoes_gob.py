...
class NotificacaoIniciacao:
        ...
        with get_db_connection() as cursor:
            if dados.get('id'):
                ...
                """, (
                    ...
                    dados.get('numero_obreiros'), dados.get('presidente_comissao'),
                ...
                """, (
                    ...
                    dados['ritual_utilizado'], dados.get('numero_obreiros'),
    ...
    def atualizar_status(id, status, protocolo=None, data_envio=None):
        """Atualiza o status da notificação - MÉTODO ADICIONADO"""
        with get_db_connection() as cursor:
            if protocolo:
                cursor.execute("""
                    UPDATE notificacoes_iniciacao SET
...
# Classes para Elevacao e Exaltacao (com os mesmos métodos)
            ...
            if dados.get('id'):
                cursor.execute("""
                    UPDATE notificacoes_elevacao SET
                        ...
                        data_iniciacao = %s, data_elevacao = %s, tempo_aprendiz = %s,
                        frequencia_sessoes = %s, trabalhos_apresentados = %s,
                        nota_exame = %s, conceito_final = %s, ata_numero = %s,
                        ata_data = %s, status_envio = %s, data_envio = %s,
                        protocolo_gob = %s
                    WHERE id = %s
                """, (dados['numero_processo'], dados['loja_nome'], dados['loja_numero'],
                      dados['loja_oriente'], dados['data_sessao'], dados['nome_aprendiz'],
                      dados['data_iniciacao'], dados['data_elevacao'], dados['tempo_aprendiz'],
                      dados['frequencia_sessoes'], dados['trabalhos_apresentados'],
                      dados['nota_exame'], dados['conceito_final'], dados['ata_numero'],
                      dados['ata_data'], dados.get('status_envio', 'pendente'),
                      dados.get('data_envio'), dados.get('protocolo_gob'), dados['id']))
                return dados['id']
            else:
                cursor.execute("""
                    INSERT INTO notificacoes_elevacao (
                        candidato_id, numero_processo, loja_nome, loja_numero, loja_oriente,
                        data_sessao, nome_aprendiz, data_iniciacao, data_elevacao,
                ...
                """, (dados['candidato_id'], dados['numero_processo'], dados['loja_nome'],
                      dados['loja_numero'], dados['loja_oriente'], dados['data_sessao'],
                      dados['nome_aprendiz'], dados['data_iniciacao'], dados['data_elevacao'],
            ...
            if dados.get('id'):
                cursor.execute("""
                    UPDATE notificacoes_exaltacao SET
                        ...
                        data_iniciacao = %s, data_elevacao = %s, data_exaltacao = %s,
                        trabalhos_apresentados = %s, terca_camara = %s,
                        prova_camara_meio = %s, prova_camara_justica = %s,
                        ata_numero = %s, ata_data = %s, status_envio = %s,
                        data_envio = %s, protocolo_gob = %s
                    WHERE id = %s
                """, (dados['numero_processo'], dados['loja_nome'], dados['loja_numero'],
                      dados['loja_oriente'], dados['data_sessao'], dados['nome_companheiro'],
                      dados['data_iniciacao'], dados['data_elevacao'], dados['data_exaltacao'],
                      dados['trabalhos_apresentados'], dados['terca_camara'],
                      dados['prova_camara_meio'], dados['prova_camara_justica'],
                      dados['ata_numero'], dados['ata_data'], dados.get('status_envio', 'pendente'),
                      dados.get('data_envio'), dados.get('protocolo_gob'), dados['id']))
                return dados['id']
            else:
                cursor.execute("""
                    INSERT INTO notificacoes_exaltacao (
                        candidato_id, numero_processo, loja_nome, loja_numero, loja_oriente,
                        data_sessao, nome_companheiro, data_iniciacao, data_elevacao,
                        data_exaltacao, trabalhos_apresentados, terca_camara,
                        prova_camara_meio, prova_camara_justica, ata_numero, ata_data,
                        status_envio, created_at
                    ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                    RETURNING id
                """, (dados['candidato_id'], dados['numero_processo'], dados['loja_nome'],
                      dados['loja_numero'], dados['loja_oriente'], dados['data_sessao'],
                      dados['nome_companheiro'], dados['data_iniciacao'], dados['data_elevacao'],
